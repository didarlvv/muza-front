...
import { ChevronDown, ChevronUp, Search, Plus, MoreHorizontal } from "lucide-react"
    ...
    <AdminLayout>
      <Card className="mb-6 bg-gradient-to-b from-white to-gray-50">
        <CardHeader className="flex flex-col sm:flex-row justify-between items-center">
          <CardTitle className="text-2xl font-bold text-gray-900 mb-4 sm:mb-0">Пользователи</CardTitle>
