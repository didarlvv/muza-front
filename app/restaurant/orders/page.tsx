        ...
        <CardContent>
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              {groupedOrders.map(({ date, orders: dateOrders }, index) => (
                <Card
                  key={date}
                  className="bg-white rounded-lg shadow-sm"
                  style={{ marginTop: index === 0 ? "0px" : "0px" }}
                >
                  ...
                  <CardContent className="p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {dateOrders.map((order) => (
                        <Card
                          key={order.id}
                          className="overflow-hidden transition-all duration-300 hover:shadow-md hover:scale-102 text-xs flex flex-col h-full"
                        >
                          <CardHeader className="p-2 pb-1 bg-gradient-to-r from-primary/10 to-primary/5">
                          ...
                          <CardContent className="p-2 pt-0 space-y-1 flex-grow flex flex-col">
                            ...
                            <div className="pt-1 border-t border-gray-200 space-y-0.5">
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p>
                                      {order.note || "Примечание отсутствует"}
                                    </p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                                ...
                                <div className="flex justify-between items-center pt-1 text-[10px]">
                                  ...
                                  {remainingPayment > 0 ? (
                                    <span className="text-amber-600 font-medium">
                                      Осталось оплатить:{" "}
                                      {remainingPayment.toFixed(2)} TMT
                                    </span>
                                  ) : (
